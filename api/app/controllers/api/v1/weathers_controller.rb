    ...
    class WeathersController < ApplicationController
      ...
      def feath_save_weather_data(city)
        ...
        begin
          ...
          daily_success =  @existing_days_data.length < 5 ? daily_success = Weather.save_weather_data(parsed_response:, times: [1, 2, 3, 4, 5], type: :daily, city_id: city.id, saved_data:) : true
