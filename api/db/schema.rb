...
ActiveRecord::Schema[7.0].define(version: 20_230_830_015_154) do
  create_table 'cities', force: :cascade do |t|
    ...
    t.index %w[lat lon], name: 'index_cities_on_lat_and_lon', unique: true
  ...
  create_table 'weathers', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[city_id date_time data_type], name: 'index_weathers_on_city_id_and_date_time_and_data_type', unique: true
